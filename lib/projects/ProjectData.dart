final List<Map<String, dynamic>> projectsLarge = [
  {
    ...
    "description":
    "```shell\n"
        "nilesh@dev:~\$ cd ClassHub\n"
        "nilesh@dev:~/ClassHub\$ npm start\n"
        "[✔] Server Running on Port 8000\n"
        "[✔] Database Connected\n"
        "```\n\n"
        "📌 ClassHub: Your Ultimate Study Tool\n\n"
        "📂 A complete study companion for students, providing access to syllabus, "
        "notes, assignments, and a student profile with exam results.\n\n"
        "🛠 Features:\n"
  ...
  },
  {
    ...
    "description":
    "```shell\n"
        "nilesh@dev:~\$ cd OldPortfolio\n"
        "nilesh@dev:~/OldPortfolio\$ git status\n"
  ...
  },
  {
    ...
    "```shell\n"
        ...
        "nilesh@dev:~/Portfolio\$ flutter build web\n"
        "[✔] Compiling... Done!\n"
        "```\n\n"
...
final List<Map<String, dynamic>> projectsMedium = [
  {
    ...
    "```shell\n"
        "nilesh@dev:~\$ cd ClassHub\n"
        "nilesh@dev:~/ClassHub\$ npm run dev\n"
        "[✔] Server Running on Port 8000\n"
        "```\n\n"
  ...
  },
  {
    ...
    "```shell\n"
        "nilesh@dev:~\$ cd OldPortfolio\n"
        "nilesh@dev:~/OldPortfolio\$ git log --oneline\n"
...
final List<Map<String, dynamic>> projectsSmall = [
  {
    ...
    "```shell\n"
        "nilesh@dev:~\$ cd ClassHub\n"
        "nilesh@dev:~/ClassHub\$ pm2 restart server\n"
        "[✔] Restarting...\n"
        "```\n\n"
